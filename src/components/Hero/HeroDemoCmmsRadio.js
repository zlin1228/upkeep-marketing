...
import DemoFormCmmsRadio from '../Forms/DemoFormCmmsRadio';
...
const HeroDemoCmmsRadio = ({ component, location }) => {
      ...
      <Section>
        ...
        <OuterWrapper theme={bgTheme}>
          <InnerWrapper>
            ...
            <Column>
              <DemoFormCmmsRadio location={location} />
              {showSocialProof && (
...
export default HeroDemoCmmsRadio;
